      ...
      },
      {
        "incomplete_text_handling": {
          ...
          "context_based_inference_strategy": {
            ...
            "step_5_probabilistic_context": {
              ...
              "confidence_threshold": {
                ...
                "low_below_60": "추론 중단, 보이는 텍스트만 제목에 사용"
              }
            }
          },
          ...
          "detailed_completion_examples": {
            ...
            "example_4": {
              "scenario": "확신도 낮은 경우 - 추론 포기",
              "input": "내일 중요한 약...",
              "context_analysis": {
                "temporal": "내일 → 일정 또는 할일",
                "spatial": "주변 정보 부족",
                "interface": "섹션 불명확",
                "semantic": "'약'으로 시작 → '약속', '약', '약국', '약수터' 등 너무 다양",
                "probability": "모든 후보가 30% 미만"
              },
              "decision": "확신도 30% → low → 추론 중단",
              "final_output": "내일 중요한 약"
            },
          ...
          "fallback_strategy": {
            ...
            "rules": [
              "확신도 60% 미만이면 추론하지 않고 보이는 텍스트만 사용",
